export class AudioManager {
    ...
    play(name) {
        ...
        const sounds = {
            ...
            buy: { freq: [800, 1000], duration: [0.1, 0.1], type: 'sine' }
        };
        ...
        if (Array.isArray(sound.freq)) {
            sound.freq.forEach((freq, i) => {
                setTimeout(() => this.playTone(freq, Array.isArray(sound.duration)?sound.duration[i]:sound.duration, sound.type), i*80);
            });
        } else {
